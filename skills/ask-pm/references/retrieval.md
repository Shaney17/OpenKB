...
3. Concept/entity là bản tổng hợp; summary giúp định vị tài liệu gốc. Frontmatter sources của concept dẫn tới summary; full_text của summary dẫn tới source. Với project, mở sources/ bằng read_space_page trong đúng space; đó là toàn văn trang Confluence đã nhập vào KB. Cho mỗi tài liệu gốc hỗ trợ câu trả lời, gọi quote_source(path, quote, space) với câu nguyên văn để backend xác thực và hiện thẻ quote mở đúng vị trí. Không quote từ trang compile. Nếu cần link Confluence, chỉ lấy source_url từ trang source thực sự đọc.
4. Được đọc source để đối chiếu ở cả autonomous và pm_assisted. Source không thay thế trang compiled làm căn cứ cho kết luận nghiệp vụ: nếu chỉ source có đáp án hoặc source mâu thuẫn với trang compiled, không gọi VERIFIED; nêu rõ điểm cần PM xác nhận.
5. Tài liệu dài PageIndex: get_page_content chỉ đọc wiki của KB thường. Với project child space, không gọi tool này bằng tên tài liệu của child; đọc sources/ bằng read_space_page. Nếu vẫn thiếu chi tiết cần thiết sau khi đọc nguồn, dừng ở giới hạn bằng chứng hoặc yêu cầu PM kiểm tra nguồn gốc.
